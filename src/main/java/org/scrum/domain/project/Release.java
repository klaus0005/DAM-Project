...
public class Release implements Serializable{
	...
	public void addFeature(String feature) {
		Integer featureNo = this.features.size() + 1;
		Integer featureID = Integer.valueOf(this.releaseId.toString() + featureNo);
		this.features.add(new Feature(featureID, feature, description));
